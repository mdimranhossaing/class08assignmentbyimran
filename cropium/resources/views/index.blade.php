                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="single-slide-content">
                                ...
                                <div class="hero-btn">
                                    <a href="contact" class="template-btn">get in touch</a>
                                    <a href="portfolio" class="template-btn hero-btn-2">project view</a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item branding">
                    <div class="gallery-single-item gallery-item-01 item-box-style-03">
                        ...
                        <div class="hover-state">
                            <a href="portfolio"><i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="call-to-action-bg">
                ...
                <div class="call-to-action-content">
                    ...
                    <div class="call-to-action-btn">
                        <a href="contact" class="template-btn action-btn">get in touch</a>
                    </div>
                </div>
            </div>
        </div>
