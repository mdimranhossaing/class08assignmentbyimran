                    ...
                    <div class="col-md-4 t-mb-30 mb-md-0">
                        <div class="price-card border t-bg-light">
                            <div class="price-card__img mx-auto">
                                <a href="blog-details" class="t-link">
                                    <img
                                        src="assets/img/price-img-1.png"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                            ...
                            <div class="row">
                                <div class="col-md-7 ">
                                    <div class="zl-cta__left">
                                        ...
                                        <a href="contact" class="t-link bttn bttn-md bttn-round bttn-primary text-capitalize t-mt-30">
                                            get started
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="footer-top__nav">
                                <ul class="t-list footer-top__list">
                                    <li class="footer-top__list-item">
                                        <a href="/portfolio" class="t-link footer-top__link text-uppercase sm-text">
                                            projects
                                        </a>
                                    </li>
                                    <li class="footer-top__list-item">
                                        <a href="/about" class="t-link footer-top__link text-uppercase sm-text">
                                            awards
                                        </a>
                                    </li>
                                    <li class="footer-top__list-item">
                                        <a href="/team" class="t-link footer-top__link text-uppercase sm-text">
                                            clients
                                        </a>
                                    </li>
                                    <li class="footer-top__list-item">
                                        <a href="/contact" class="t-link footer-top__link text-uppercase sm-text">
                                            contact
                                        </a>
                                    </li>
                                </ul>
